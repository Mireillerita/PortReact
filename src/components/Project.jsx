...
const Project = () => {
  return (
    <div name="project" className="w-full  project text-black">
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-centerw-full h-full">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          <div
            ...
            className="shadow-lg shadow-[#0d0e0f] group hover:scale-110 duration-500 container rounded-full flex justify-center items-center mx-auto contentP"
          >
          ...
          <div
            style={{ backgroundImage: `url(${RandomEmog})` }}
            className="shadow-lg shadow-[#0d0e0f] group hover:scale-110 duration-500 container rounded-full flex justify-center items-center mx-auto contentP"
          >
            <div className="opacity-0 text-center group-hover:opacity-100">
              <span className="font-bold tracking-wide uppercase">
          ...
          <div
            style={{ backgroundImage: `url(${Rockgame})` }}
            className="shadow-lg shadow-[#0d0e0f] group hover:scale-110 duration-500 container rounded-full flex justify-center items-center mx-auto contentP"
          >
            <div className="opacity-0 text-center group-hover:opacity-100">
              <span className="font-bold tracking-wide uppercase">
          ...
          <div
            style={{ backgroundImage: `url(${CountriesApp})` }}
            className="shadow-lg shadow-[#0d0e0f] group hover:scale-110 duration-500 container rounded-full flex justify-center items-center mx-auto contentP"
          >
            <div className="opacity-0 text-center group-hover:opacity-100">
              <span className="font-bold tracking-wide uppercase">
